...
1. **Monolayer fitting** — fit 43 TB parameters per TMD (WSe2, WS2) to ARPES band dispersion data via dual annealing + Nelder-Mead. Results are saved as `.npz` files and pre-fitted `.npy` parameter sets.
