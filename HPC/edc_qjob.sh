...
OUTPUT_FILE=Scratch/edc_gamma_${RUN_ID}_task${SGE_TASK_ID}.out
ERROR_FILE=Scratch/edc_gamma_${RUN_ID}_task${SGE_TASK_ID}.err

python3 scripts/edc_grid_gamma.py --chunk ${TASK_ID}/${N_TASKS} --run-id ${RUN_ID} >${OUTPUT_FILE} 2>${ERROR_FILE}
