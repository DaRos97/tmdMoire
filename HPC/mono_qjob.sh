...
OUTPUT_FILE=Scratch/${MATERIAL}_${RUN_ID}_task${SGE_TASK_ID}.out
ERROR_FILE=Scratch/${MATERIAL}_${RUN_ID}_task${SGE_TASK_ID}.err

python3 scripts/run_monolayer_grid.py ${MATERIAL} --chunk ${TASK_ID}/${N_TASKS} --id ${RUN_ID} >${OUTPUT_FILE} 2>${ERROR_FILE}
